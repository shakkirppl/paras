...
<div class="col-12 grid-margin createtable">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="col-md-6 heading">
                             <a href="{{ url('product-attributes') }}" class="backicon"><i class="mdi mdi-backburger"></i></a>
                        </div>
                        <div class="col-md-6">
                        </div>
                    </div>
          ...
          @endif
                  ...
                  <form class="form-sample"  action="{{ route('product-attributes.store') }}" method="post" enctype="multipart/form-data"  >
                          {{csrf_field()}}
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="Value eg:colur or size" name="value"  required="true"  value="{{old('value')}}" />
                          </div>
                        </div>
                      </div>
