...
<div class="col-12 grid-margin createtable">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="col-md-6 heading">
                             <a href="{{ route('sub-category.index') }}" class="backicon"><i class="mdi mdi-backburger"></i></a>
                        </div>
                        <div class="col-md-6">
                        </div>
                    </div>
          ...
          @endif
                  ...
                  <form class="form-sample"  action="{{ route('sub-category.store') }}" method="post" enctype="multipart/form-data"  >
                          {{csrf_field()}}
                    <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="Sub Category Name" name="name"   required="true" value="{{old('name')}}" />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                        <select class="form-control form-control-lg" id="categories_id" name="categories_id" required="true">
