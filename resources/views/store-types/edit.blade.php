    ...
    <div class="col-12 grid-margin createtable">
      <div class="card">
        <div class="card-body">
          ...
          <form class="form-sample" action="{{ route('store-type.update', $storeType->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
              <div class="col-md-12">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" placeholder="Type" name="code" value="{{ old('code', $storeType->code) }}" />
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" placeholder="Company Type" name="name" value="{{ old('name', $storeType->name) }}" />
                  </div>
                </div>
              </div>
            </div>
