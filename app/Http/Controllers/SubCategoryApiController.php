...
class SubCategoryApiController extends Controller
{
    ...
    public function category_products_section1(Request $request)
    { 
       try {
    ...
    public function category_products_section2(Request $request)
    { 
       try {
           $results = Product::select('id','name','product_code','model','brand_id','category_id','sub_category_id')
           ->with('category','subCategory','brand','skusBase')->where('sub_category_id',$request->sub_category_id)->get();
    ...
    public function category_products_section3(Request $request)
    { 
       try {
           $results = Product::select('id','name','product_code','model','brand_id','category_id','sub_category_id')
           ->with('category','subCategory','brand','skusBase')->where('sub_category_id',$request->sub_category_id)->get();
    ...
    public function category_products_section4(Request $request)
    { 
       try {
           $results = Product::select('id','name','product_code','model','brand_id','category_id','sub_category_id')
           ->with('category','subCategory','brand','skusBase')->where('sub_category_id',$request->sub_category_id)->get();
